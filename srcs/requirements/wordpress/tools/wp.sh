...
# Verifica si el archivo de configuración de WordPress existe
if [ -f ./wp-config.php ]; then
    ...
    # Crea el archivo de configuración de WordPress
    wp config create --dbname=$DB_NAME --dbuser=$DB_USER --dbpass=$DB_PASS --dbhost=$DB_HOST --allow-root

    # Instala WordPress con las credenciales y configuración proporcionadas
